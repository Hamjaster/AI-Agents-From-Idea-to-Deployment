...
def create_planning_task(agent) -> Task:
    """Task: Draft an execution plan for the selected workshop topic."""
    return Task(
        description=(
            "Analyze the provided workshop topic and craft a milestone-based execution plan. "
...
def create_research_task(agent, tools=None) -> Task:
    """Task: Gather supporting research and evidence."""
    ...
    return Task(
        description=(
            "Use the local knowledge base and live web results to validate the plan. "
...
def create_writing_task(agent) -> Task:
    """Task: Author the workshop deliverables."""
    return Task(
        description=(
            "Draft the workshop narrative, including an overview, prerequisites, step-by-step labs, and deployment notes. "
...
def create_review_task(agent) -> Task:
    """Task: Review and refine the compiled deliverables."""
    return Task(
        description=(
            "Review the draft content for accuracy, completeness, and pedagogy. Provide an executive summary of strengths, "
...
def build_workshop_tasks(planner, researcher, writer, reviewer, research_tools=None) -> List[Task]:
    """Convenience function to create the full task list in order."""
    return [
